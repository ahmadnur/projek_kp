                ...
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <form action="/login/proses" method="POST">
                        ...
                        <div class="intro-x mt-8">
                            <input type="text" class="intro-x login__input form-control py-3 px-4 block" name="username" placeholder="Username" value="<?= old('username');   ?>">
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            ...
                            <a href="/login/daftar" class="btn whitespace-nowrap btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Daftar Karyawan</a>
                        </div>
                    </form>
