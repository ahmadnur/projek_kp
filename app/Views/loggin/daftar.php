        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <?php endif; ?>
                    <form action="/login/daftar2" method="POST">
                        <input type="hidden" name="_method" value="GET">

                        <div class="intro-x mt-2 text-slate-400 xl:hidden text-center">A few more clicks to sign in to your account. Manage all your e-commerce accounts in one place</div>
                        <div class="intro-x mt-8">
                            <input type="text" class="intro-x login__input form-control py-3 px-4 block" name="ktp" placeholder="No KTP" value="<?= old('ktp');   ?>">
                            <!-- <div class="t col-span-4 text-red-500 text-xs italic whitespace-nowrap">
                                <?= $validation->getError('ktp');   ?></div> -->
                            <input type="date" class="intro-x login__input form-control py-3 px-4 block mt-4 mb-3" id="pass" name="date">
                            <div class="t col-span-4 text-red-500 text-xs italic whitespace-nowrap">
                                <?= $validation->getError('date');   ?></div>
                        </div>
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            ...
                            <a href="/pendaftaran/baru" class="btn btn-primary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Daftar</a>
                            <!-- <a href="" class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Register</a> -->
                        </div>
                    </form>
